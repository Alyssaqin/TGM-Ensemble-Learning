...
def main(argv):
    ...
    learning_rates = [0.005,0.0003,0.008]
    for lr in learning_rates:
        ...
        print(f"Test Loss for lr={lr}: {test_loss}")
        print(f"Test Acc for lr={lr}: {test_result[0].get('test_acc', 'N/A')}")
        ...
        dict_double_val = utils.getDoubleDict(val_result)
        dict_double_test = utils.getDoubleDict(test_result)
        acc_icub = test_result[0].get('test_acc', None)
