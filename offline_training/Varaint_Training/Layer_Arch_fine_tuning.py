...
def main(argv):
    ...
    for variant_name, (mess1, node1, mess2, node2) in arch_variants.items():
        print(f"\n=== Training variant: {variant_name} ===")

        FLAGS.h_mess_arch_1 = mess1
        FLAGS.h_node_arch_1 = node1
        FLAGS.h_mess_arch_2 = mess2
        FLAGS.h_node_arch_2 = node2

        #FLAGS.project_config_name = f"Teenager"
        #FLAGS.wandb_project_name = f"GNN"
